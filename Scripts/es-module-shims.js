...
(function () {
  ...
  let featureDetectionPromise = Promise.resolve(dynamicImportCheck).then(() => {
    ...
    if (!hasDocument)
      return Promise.all([
        ...
        cssModulesEnabled &&
          dynamicImport(
            createBlob(cssModulesCheck.replace("x", createBlob("", "text/css")))
  ...
  function parse(l, k = "@") {
                      ...
                      case 41: {
                        ...
                        if (
                          (r << 16) >> 16 != 0
                            ? ((u =
                                t[
                                  ((t[69] | 0) + (((r & 65535) + -1) << 2)) >> 2
                                ] | 0),
                              (t[(u + 20) >> 2] | 0) ==
                                (t[
                                  ((t[68] | 0) + ((a & 65535) << 3) + 4) >> 2
                                ] |
                                  0))
                            : 0
                        ) {
    ...
    for (; e.ri(); ) {
      ...
      let n;
      e.ip() &&
        (n = b(-1 === s ? a : a + 1, c$1.charCodeAt(-1 === s ? a - 1 : a))),
    ...
    for (; e.re(); ) {
      ...
      d.push({
        ...
        ln:
          i < 0 ? void 0 : 34 === f || 39 === f ? b(i + 1, f) : c$1.slice(i, s),
      });
    }
    return [w, d, !!e.f()];
  }
    ...
    switch ((++n, e)) {
      ...
      case 117:
        return (function () {
          ...
          let a;
          123 === e
            ? (++n, (a = k(c$1.indexOf("}", n) - n)), ++n, a > 1114111 && o())
            : (a = k(4));
          return a <= 65535
  ...
  function resolveDeps(load, seen) {
    ...
    function pushStringTo(originalIndex) {
      while (
        dynamicImportEndStack[dynamicImportEndStack.length - 1] < originalIndex
      ) {
    ...
    let sourceMapURLCommentStart = source.lastIndexOf(
      sourceMapURLCommentPrefix
    );
    ...
    if (
      ...
      (sourceMapURLCommentStart === -1 ||
        sourceMapURLCommentStart > sourceURLCommentStart)
    ) {
    ...
    if (sourceMapURLCommentStart !== -1) {
      ...
      if (
        sourceURLCommentStart !== -1 &&
        sourceURLCommentStart > sourceMapURLCommentStart
      )
        pushSourceURL(sourceURLCommentPrefix, sourceURLCommentStart);
    }
